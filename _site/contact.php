...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <head>
        ...
        <meta name="keywords" content="reclamebureau, communicatiebureau, marketingbureau, gouwestad, waddinxveen, gouda, boskoop, zoetermeer, webdesign, website contact, contactgegevens, werk met met ons">
        ...
        <!-- Google -->
        <meta itemprop="name" content="Werk met ons | Contact - Gouwestad Marketing & Media">
        <meta itemprop="description" content="Contactgegevens van Gouwestad Marketing & Media en waarom je met ons zou willen werken">
  ...
  <div class="container">
    <div class="row fast-links">
      <div class="col col-lg-4">
        <a class="btn btn-block home" href="http://localhost:4000">homepage</a>
      </div>
      <div class="col col-lg-4">
        <a class="btn btn-block us" href="http://localhost:4000/wat-wij-doen">wat wij doen</a>
      </div>
       <div class="col col-lg-4">
        <a class="btn btn-block contact" href="http://localhost:4000/contact.php">contact</a>
      </div>
    </div>

    <div class="row">
      <div class="page-header">
        <h4>Ons recente werk:</h4>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col col-lg-12">
        <ul class="nav">
          <li>
            <a href="http://localhost:4000/werk/gouwestadmakelaardij">
              <h2>Gouwestad makelaardij</h2>
              <p>responsive webdesign</p>
            </a>
          </li>
          <li>
            <a href="http://localhost:4000/werk/zuidplashof">
              <h2>Zuidplashof</h2>
              <p>een digitale verhuurcampagne</p>
            </a>
          </li>
          <li>
            <a href="http://localhost:4000/werk/tourmalijn">
              <h2>Tourmalijn</h2>
              <p>retro in een nieuw jasje</p>
            </a>
          </li>
          <li>
            <a href="http://localhost:4000/werk/mijntypea">
              <h2>Mijn Type A</h2>
          ...
          <hr>
          <li>
            <a href="http://localhost:4000/overons">
                ...
                <form method="post" action="process.php">
                  ...
                  <div class="row">
                    <div class="controls col col-lg-12 center">
                        <button id="contact-submit" type="submit" class="btn btn-primary"><i class="icon-envelope"></i> versturen</button>
                    </div>
                  </div>
                </form>
              </div>
...
<script type="text/javascript">
  function initialize() {
    var latlng = new google.maps.LatLng(52.052425, 4.661658); // Change these values, to those appropriate for your location
  ...
  <script>window.jQuery || document.write('<script src="http://localhost:4000/js/vendor/jquery-1.8.2.min.js"><\/script>')</script> -->
    ...
    <script src="http://localhost:4000/js/vendor/jquery.flexslider-min.js"></script>
